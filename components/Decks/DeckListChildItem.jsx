...
const DeckListChildItem = ({ parentDeck, deck, parent }) => {
  ...
  return (
    <View>
      ...
      <Pressable onPress={() => {navigation.navigate("Deck", {deck: deck, length: deck.cards.length})}} className="flex flex-row p-4 mb-2 mr-3 ml-8 items-center justify-between border-b-2 border-gray-100">
